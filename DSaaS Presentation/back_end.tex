	...
	\frametitle{Back End}
	 \newcommand{\backEnd}[0] {
      ...
      \begin{scope}[>=stealth]
        ...
        \node (nodejs) [above=0cm of apiService]{\includegraphics[width=0.3\textwidth]{images/nodejs.png}};
        ...
        \node (db1logo) [above=0cm of db1]{\includegraphics[width=0.2\textwidth]{images/leveldb.png}};
        ...
        \node (db2logo) [above=0cm of db2]{\includegraphics[width=0.2\textwidth]{images/mongodb.png}};
